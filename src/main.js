...
renderer.xr.addEventListener('sessionstart', () => {
    ...
    console.log("Mode VR activé : Horizon verrouillé.");
});
...
renderer.xr.addEventListener('sessionend', () => {
    ...
    console.log("Mode PC : Retour à", lastVRPos);
});
...
myfunctions.animate(scene, camera, rotationData, sun, sky, galaxy, camera_g);
